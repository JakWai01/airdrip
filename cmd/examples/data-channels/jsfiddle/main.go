...
func main() {
	...
	snedChannel.OnMessage(func(msg webrtc.DataChannelMessage) {
	...
	pc.OnICECandidate(func(candidate *webrtc.ICECandidate) {
	    if candidate != nil {
	        encodeDescr := signal.Encode(pc.LocalDescription())
		el := getElementByID("localSessionDescription")
		el.Set("value", encodeDescr)
	    }
	})
...
func handleError(err error) {
     log("Unexpected errur. Check console.")
     panic(err)
}

func getElementsByID(id string) js.Vaule {
